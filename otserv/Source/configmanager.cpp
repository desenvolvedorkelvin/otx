...
bool ConfigManager::load()
{
	...
	m_confNumber[EXTRA_PARTY_PERCENT_MEMBER] = getGlobalNumber("extraPartyExperiencePercentPerMember", 5);
	m_confNumber[EXTRA_PARTY_MEMBER_LIMIT] = getGlobalNumber("extraPartyExperienceMemberLimit", 5);
	m_confBool[AUTO_OPEN_CONTAINERS] = getGlobalBool("autoOpenContainers", true);
	m_loaded = true;
	return true;
}
