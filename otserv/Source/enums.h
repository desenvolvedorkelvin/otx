...
{
	SPECIALSKILL_LIFELEECH,
	SPECIALSKILL_MANALEECH,
	SPECIALSKILL_DODGECHANCE,
	SPECIALSKILL_CRITICALCHANCE,
	SPECIALSKILL_CRITICALDAMAGE,

	SPECIALSKILL_FIRST = SPECIALSKILL_LIFELEECH,
	SPECIALSKILL_LAST = SPECIALSKILL_CRITICALDAMAGE
};
