...
class Player : public Creature, public Cylinder
{
	public:
		...
		const ContainerVector& getOpenContainers() const {
			return containerVec;
		}
		...
		int32_t getSpecialSkill(SpecialSkills_t skill) const {
			return specialSkill[skill];
		}
		void addSpecialSkill(SpecialSkills_t skill, int32_t modifier) {
			specialSkill[skill] += modifier;
		}
	...
	private:
		...
		int32_t specialSkill[SPECIALSKILL_LAST + 1];
