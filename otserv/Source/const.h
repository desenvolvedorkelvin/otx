...
enum MagicEffect_t
{
	...
	MAGIC_EFFECT_DADOS = 25,
	MAGIC_EFFECT_BIGPLANTS = 26,
	MAGIC_EFFECT_BUBBLES = 27,
	MAGIC_EFFECT_SMALLPLANTS = 28,
	MAGIC_EFFECT_PURPLEENERGY = 29,
	MAGIC_EFFECT_YELLOWENERGY = 30,
	MAGIC_EFFECT_SMALLCLOUDS = 31,
	MAGIC_EFFECT_STUN = 32,
	MAGIC_EFFECT_FIREATTACK = 33,
	MAGIC_EFFECT_ICEAREA = 34,
	MAGIC_EFFECT_ICEATTACK = 35,
	MAGIC_EFFECT_PLANTATTACK = 36,
	MAGIC_EFFECT_ENERGYAREA = 37,
	MAGIC_EFFECT_HOLYDAMAGE = 38,
	MAGIC_EFFECT_GROUNDSHAKER = 39,
	MAGIC_EFFECT_SLEEP = 40,
	MAGIC_EFFECT_HOLYAREA = 41,
	MAGIC_EFFECT_BIGCLOUDS = 42,
	MAGIC_EFFECT_HEARTS = 43,
	MAGIC_EFFECT_CARNIPHILA = 44,
	MAGIC_EFFECT_LAST = MAGIC_EFFECT_CARNIPHILA,
...
enum ShootEffect_t
{
	...
	SHOOT_EFFECT_SMALLEARTH = 15,
	SHOOT_EFFECT_SUDDENDEATH = 16,
	SHOOT_EFFECT_WHIRLWINDSWORD = 17,
	SHOOT_EFFECT_ICE = 18,	
	SHOOT_EFFECT_SMALLHOLY = 19,
	SHOOT_EFFECT_HOLY = 20,
	SHOOT_EFFECT_WHIRLWINDCLUB = 21,
	SHOOT_EFFECT_WHIRLWINDSWORDD = 22,
	SHOOT_EFFECT_EXPLOSION = 23,
	SHOOT_EFFECT_EARTH = 24,
	SHOOT_EFFECT_ENERGYBALL = 25,
	SHOOT_EFFECT_INFERNALBOLT = 26,
