 ...
 local function creatureSayCallback(cid, type, msg)
	...
	return true
       ...
       local travelNode = keywordHandler:addKeyword({'hills'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you want to fly to fermo hills for 60 gold coins?'})
        ...
        keywordHandler:addKeyword({'fly'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can take you to Svargrond, Femor hills and Edron.'})
        keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I only can offer you my services to Svargrond, Femor hills and Edron.'})
